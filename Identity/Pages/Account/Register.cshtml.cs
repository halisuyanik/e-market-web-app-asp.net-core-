...
namespace on_e_commerce.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var user = new AppUser { UserName = Input.Email, Ad=Input.Name, Soyad=Input.Surname, OlusturulmaTarihi=DateTime.Now, Email = Input.Email };
